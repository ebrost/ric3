...
class OeuvresAppModel extends AppModel{
  public $tablePrefix='ric_oeuvres_';
  
  
    protected $activityRoot = '';
    protected $activityLevelsDisplay = -1;
    protected $searchFormType = null;
    protected $fulltextSearchFields='nom_complet,commentaires,auteur,co_auteur,realisateur,compositeur,choregraphe,metteurenscene,scenariste,illustrateur';
	...
	public function getConfig(){
		...
		$this->config= Configure::read('Oeuvres');
		}
